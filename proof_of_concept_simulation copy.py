...
center = L / 2
width = 1.0
grid = x  # Renamed for clarity
packet_center = center  # Descriptive variable for wave packet's center
packet_width = width  # Descriptive variable for wave packet's width

psi_global = initialize_wave_function(grid, packet_center, packet_width)
psi_global = initialize_wave_function(x, center, width)
